...
def draw_plot(
    ...
    # Horizontal grid and labels (mean: 0..255)
    ...
    # Variance curves share same plot area, mapped by adjustable vertical ratio
    ...
    cv2.putText(
        canvas,
        f"samples: {n}/{MAX_POINTS} | var_scale: {var_scale:.2f} | +/- adjust",
        (margin_left, h - 6),
        cv2.FONT_HERSHEY_SIMPLEX,
        0.45,
        (180, 180, 180),
